...
class TimerScreenInternal extends StatefulWidget {
  const TimerScreenInternal({super.key});

  @override
  State<TimerScreenInternal> createState() => _TimerScreenInternalState();
}

class _TimerScreenInternalState extends State<TimerScreenInternal> {
  Uint8List? _image;
